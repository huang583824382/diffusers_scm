...
class StableDiffusionXLPipeline(
    ...
    def predict_scm(
        ...
        **kwargs,
        ...
        alpha_schedule = torch.sqrt(self.scheduler.alphas_cumprod).to(device)
        sigma_schedule = torch.sqrt(1 - self.scheduler.alphas_cumprod).to(device)
        ...
        c_skip_noise, c_out_noise = self.scheduler.get_scalings_for_boundary_condition_discrete(
            timesteps
        )
        
        # print(c_skip_noise)
        # print(c_out_noise)
        # print(latents.dtype, latents.shape)
        # print(latent_model_input.dtype, latent_model_input.shape)
        
        target = c_skip_noise * latents + c_out_noise * pred_x_0
