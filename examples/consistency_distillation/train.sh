...
accelerate launch train_scm_distill_sdxl_wds.py \
  ...
  --output_dir="CC12M-scm-sdxl-wds-test_uncond" \
  ...
  --train_shards_path_or_url="pipe:curl -L -s http://hf-mirror.com/datasets/laion/conceptual-captions-12m-webdataset/resolve/main/data/{00000..01099}.tar" \
